...
class_book, class_num = get_classes('/home/server2/shk/yolox_drone/model_data/visdrone10.txt')
...
def main():
    ...
    dataset_anno = 'UAVDT/annotations/UAV-benchmark-M-Val.json'

    first_txt_dir = 'detection-results0'
    txt_dir = 'detection-results1'
    out_dir = 'out'
   ...
   #  coarse_detecor = init_detector(coarse_detecor_config, coarse_detecor_config_ckpt, device=device)
    ...
    for key in range(size):
        ...
        tmp_txt_path = os.path.join(first_txt_dir, img_name.replace(".jpg", ".txt"))
        ...
        tmp_txt_path = os.path.join(txt_dir, img_name.replace(".jpg", ".txt"))
        print(tmp_txt_path)
        ...
        # write txt results
        out_txt_path = os.path.join(out_dir, img_name.replace(".jpg", ".txt"))

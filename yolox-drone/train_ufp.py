...
# from models.dfpn.yolox_dfpnv2 import YoloBody
# from models.base.yolox_fpn import YoloBody
# from models.ffa.yolox_ftt import YoloBody


from models.base.yolox_losses import YOLOLoss, weights_init
# from models.ffa.yolox_losses import YOLOLoss, weights_init
...
if __name__ == "__main__":
    ...
    # model_path = '/home/server2/shk/yolox_drone/work_dir/yolox_ftt_33999/ep080-loss4.145-val_loss4.349.pth'
    log_dir = 'work_dir/yolox_baseline_ufp' + '_' + str(seed_num)
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = 'model_data/2007_train_ufp.txt'
    val_annotation_path = 'model_data/2007_val_ufp.txt'
    ...
    if True:
        ...
        if scheduler_mode == 'CosineAnnealingLR':
            ...
            lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=2, gamma=0.92)

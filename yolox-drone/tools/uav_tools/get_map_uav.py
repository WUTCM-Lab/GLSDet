...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-path', default='work_dir/uav_recls_80_loss40_5973/ep080-loss1.923-val_loss2.041.pth')
    # parser.add_argument('--model-config', default='models/base/yolox8.py')
    parser.add_argument('--model-config', default='models/decouple/yolox_recls.py')
    ...
    #   默认指向根目录下的VOC数据集
    # -------------------------------------------------------#
    VOCdevkit_path = '/share/home/wut_zhangb/UAVDT/UAVVOCdevkit_val'
    # -------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    # -------------------------------------------------------#
    import random
    ...
    if map_mode == 0 or map_mode == 1:
        print("Load model.")
        yolo = YOLO(confidence=0.0001, nms_iou=nms_iou, model_path=model_path, config_path=config_path, decode_mode=decode_mode, classes_path=classes_path)

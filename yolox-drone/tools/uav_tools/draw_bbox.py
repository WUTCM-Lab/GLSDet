    ...
    def draw_by_voc(self):
        ...
        for index, xml_file in enumerate(os.listdir(self.src_path)):
            ...
            for obj in objects:
                ...
                cv2.putText(image, name, (x1, y1), cv2.FONT_HERSHEY_PLAIN, 1.2, (0, 255, 0), 2)
...
if __name__ == '__main__':
    # how to use?
    draw_bbox = DrawBBox('/home/server2/shk/yolox_drone/uav_tools/2/',
                         '/home/server2/shk/yolox_drone/uav_tools/1',

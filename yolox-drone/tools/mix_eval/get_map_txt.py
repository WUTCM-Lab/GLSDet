...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-path', default='/home/server2/shk/yolox_drone/work_dir/yolox_ftt_33999/ep076-loss4.187-val_loss4.343.pth')
   ...
   # parser.add_argument('--model-config', default='models/dfpn/yolox_scam.py')
    ...
    if map_mode == 0:
        ...
        get_coco_map_txt(
        class_names,
        "/home/server2/shk/yolox_drone/results/ftt640/ground-truth",
        "/home/server2/shk/yolox_drone/results/0000vis",

...
if __name__ == "__main__":
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = 'model_data/2007_train_uav.txt'
    val_annotation_path = 'model_data/2007_val_uav.txt'
    ...
    if True:
        ...
        if scheduler_mode == 'CosineAnnealingLR':
            ...
            lr_scheduler = optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=10, T_mult=1, eta_min=1e-5,
                                                                          last_epoch=-1)

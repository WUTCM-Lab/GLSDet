...
from models.ffa.yolox_ffa import YoloBody
...
if __name__ == "__main__":
    ...
    log_dir = 'work_dir/yolox_uav_ufp'
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = 'model_data/2007_train_uav_ufp.txt'
    val_annotation_path = 'model_data/2007_val_uav_ufp.txt'

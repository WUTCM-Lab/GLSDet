...
from models.new.Non_local_family import Attention
...
class CSPDarknet(nn.Module):
    def __init__(self, dep_mul, wid_mul, out_features=("dark2", "dark3", "dark4", "dark5"), depthwise=False, act="silu", ):
        ...
        self.lsk2 = Attention(base_channels * 2)
        self.lsk3 = Attention(base_channels * 4)
        self.lsk4 = Attention(base_channels * 8)
        self.lsk5 = Attention(base_channels * 16)
